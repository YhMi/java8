...
public class MethodReference {
    public static void main(String[] args) {
        ...
        useConsumer(System.out::println,"Hello Yhmi");
        List<Apple> list= Arrays.asList(new Apple("Green",110),new Apple("red",123),new Apple("abx",123));
        ...
        ComplexApple complexApple = threeFunction.apply("Green", 123L, "富士");
        System.out.println(complexApple);

        List<Apple> list2= Arrays.asList(new Apple("Green",110),new Apple("red",123),new Apple("abx",123));
